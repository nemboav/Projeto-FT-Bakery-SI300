...
#include <vector>
#include <iostream>
#include <iomanip> // Adicionado para usar a função setw e setprecision
...
void MyProgram::insertCottageCheese()
{
    ...
    myMainList.push_back(cottageCheese);
...
void MyProgram::insertMortadella()
{
    ...
    myMainList.push_back(mortadella);
